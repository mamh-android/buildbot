...
from buildbot.status.web.login import LoginPage
...
from buildbot.status.web.autobuild import StatusQuery
from buildbot.status.web.configdailybuild import ConfigAutobuild
from buildbot.status.web.trigger import TriggerBuild
from buildbot.status.web.query import QueryBuild
from buildbot.status.web.branchquery import BranchStatus
...
class WebStatus(service.MultiService):
    ...
    def __init__(self, http_port=None, distrib_port=None, allowForce=None,
                 public_html="public_html", site=None, numbuilds=50,
    ...
    def setupUsualPages(self, numbuilds, num_events, num_events_max):
        ...
        self.putChild("autobuild", StatusQuery())
        self.putChild("configbuild", ConfigAutobuild())
        self.putChild("trigger", TriggerBuild())
        self.putChild("query", QueryBuild())
        self.putChild("branchquery", BranchStatus())
        #add by zlinghu begin:20111209---add login page
        self.putChild("login", LoginPage())
        #add by zlinghu end
