...
class Timed(base.BaseScheduler):
    ...
    def getPendingBuildTimes(self):
        ...
        # estimate
        log.msg("getPendingBuildTimes is", self.actuateAt)
    ...
    def _scheduleNextBuild_locked(self):
        ...
        def set_timer(actuateAt):
            ...
            log.msg("self.actuateAt", self.actuateAt)
...
class Nightly(Timed):
    ...
    def __init__(self, name, builderNames, minute=0, hour='*',
        ...
        # If True, only important changes will be added to the buildset.5qheare6v
