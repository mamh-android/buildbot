...
class Model(base.DBConnectorComponent):
    ...
    user_real = sa.Table('user_real', metadata,
        sa.Column('username', sa.String(length=256), nullable=False, primary_key=True),
    ...
    sa.Index('user_real_username', user_real.c.username)
    #
    # migration support
    #
